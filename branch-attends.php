...
echo "<thead><tr><th>Member ID</th><th>Name</th><th>Branch ID</th><th>City</th></tr></thead>";
echo "<tbody>";

while($row = $stmt->fetch()){
    echo "<tr><td>$row[member_id]</td><td>$row[name]</td><td>$row[branch_id]</td><td>$row[city]</td></tr>";
